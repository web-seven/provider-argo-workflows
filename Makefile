...
xpkg.build.provider-argo: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Argo CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Argo controllers
...
# This target prepares repo for your provider by replacing all "argo"
