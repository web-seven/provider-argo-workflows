...
The [provider-argo](https://github.com/web-seven/provider-argo-workflows) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-argo](https://github.com/crossplane-contrib/provider-jet-argo) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/web-seven/provider-argo-workflows/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/web-seven/provider-argo-workflows/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/web-seven/provider-argo-workflows/blob/main/hack/boilerplate.go.txt](https://github.com/web-seven/provider-argo-workflows/blob/main/hack/boilerplate.go.txt)
...
The [provider-argo](https://github.com/web-seven/provider-argo-workflows)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/web-seven/provider-argo-workflows/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/web-seven/provider-argo-workflows/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue argos (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/web-seven/provider-argo-workflows/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request Argos: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/web-seven/provider-argo-workflows/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
